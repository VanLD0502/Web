...
})({"hD98U":[function(require,module,exports,__globalThis) {
...
},{"./App":"hh6uc","./assets/style.css":"gWDlB","./assets/style.scss":"ll5JQ"}],"hh6uc":[function(require,module,exports,__globalThis) {
...
const { SERVER_API, PAGE_LIMIT } = (0, _configJsonDefault.default);
console.log(`SERVER_API = ${SERVER_API}, PAGE_LIMIT = ${PAGE_LIMIT}`);
const App = ()=>{
    return `
        ${(0, _header.Header)()}
        <h1>Hello F8 ${(0, _momentDefault.default)().format('YY-MM-DD')}</h1>
        ${(0, _footer.Footer)()}`;
};

},{"moment":"kty5A","./components/Header":"3PJ6N","./components/Footer":"lq1kZ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./config.json":"61VGM"}],"kty5A":[function(require,module,exports,__globalThis) {
//! moment.js
//! version : 2.30.1
...
const Footer = ()=>{
    return `<div class = 'content'><h2>Footer</h2></div>`;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"61VGM":[function(require,module,exports,__globalThis) {
module.exports = JSON.parse("{\"SERVER_API\":\"http://localhost:3000\",\"PAGE_LIMIT\":3}");

},{}],"gWDlB":[function() {},{}],"ll5JQ":[function() {},{}]},["hD98U","a0t4e"], "a0t4e", "parcelRequire3298", {})

//# sourceMappingURL=bundler.31b563d9.js.map
